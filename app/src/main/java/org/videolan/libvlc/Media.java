...
public class Media implements Comparable<Media> {
     ...
     *
     * @see org.videolan.libvlc.Util#getValue(String, int)
     *
     ...
     * due to lazy-loading.
     *
     * Use {@link org.videolan.libvlc.Util#getPictureFromCache(Media)} instead.
     *
     ...
     *
     * In VLC for Android, use {@link org.videolan.libvlc.Util#setPicture(Context, Media, Bitmap)} instead.
     *
     * @param p
     */
